    ...
    public function create(Request $request)
    {
        ...
        $assets = $assetsQuery->get()->map(function ($asset) {
            ...
            return [
                ...
                'fields' => $fields,
                'asset_name' => $asset->asset_name ?? $fields['asset_name'] ?? null,
                'asset_id' => $asset->asset_id ?? $fields['asset_id'] ?? $fields['aset_id'] ?? null,
                'serial_number' => $asset->serial_number ?? $fields['serial_number'] ?? null,
