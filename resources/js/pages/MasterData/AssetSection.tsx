...
import { Plus, Edit, Trash2, Layers, Shapes, Palette } from 'lucide-react';

type SubTab = 'categories' | 'types' | 'statuses';

const presetColors = ['#6B7280', '#EF4444', '#EAB308', '#22C55E', '#3B82F6', '#F97316', '#8B5CF6', '#EC4899', '#14B8A6', '#F43F5E'];

export default function AssetSection({ categories, types, assetStatuses, isAdmin }: any) {
