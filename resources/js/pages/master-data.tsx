...
export default function MasterData({ categories = [], types = [], sites = [], vendors = [] }: MasterDataProps) {
    ...
    const handleDelete = (id: number) => {
        ...
        router.delete(`/master-data/${activeTab}/${id}`, { preserveScroll: true });
    };
    ...
    const tabConfig = {
        sites: {
            ...
            columns: [
                ...
                { accessorKey: "code", header: ({ column }: any) => <DataTableColumnHeader column={column} title="Code" /> },
            ...
            renderForm: () => (
                <>
                    ...
                    <div className="grid gap-2">
                        ...
                        <Select value={formData.asset_category_id || ''} onValueChange={val => setFormData({ ...formData, asset_category_id: val })}>
                            <SelectTrigger>
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        Manage system reference data, classifications, and vendors.
                    </p>
                </div>
            </div>
