...
export default function RecycleBin({ items, filters }: RecycleBinProps) {
    ...
    const handleRestore = (id: number) => {
        if (confirm('Are you sure you want to restore this item?')) {
            router.post(`/security/recycle-bin/${id}/restore`, { type }, { preserveScroll: true });
        }
    };
    ...
    const getTypeLabel = (t: string) => {
        switch (t) {
            ...
            case 'asset_categories': return 'Asset Categories';
    ...
    const columns = React.useMemo(() => [
        ...
        },
        {
            ...
            cell: ({ row }: any) => (
                <span>{new Date(row.original.deleted_at).toLocaleString()}</span>
            )
        },
        {
            id: "actions",
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage and restore deleted records across the system.</p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Review deleted items. Restoring will bring them back, permanent deletion will erase them forever.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <div className="w-[200px]">
                            <Select value={type} onValueChange={handleFilterChange}>
                                ...
                                <SelectContent>
                                    ...
                                    <SelectItem value="asset_categories">Asset Categories</SelectItem>
