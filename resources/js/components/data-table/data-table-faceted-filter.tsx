...
export function DataTableFacetedFilter<TData, TValue>({
    ...
    return (
        <div ref={containerRef} className="relative">
            ...
            {open && (
                <div className="absolute left-0 top-[calc(100%+4px)] z-50 w-56 rounded-md border bg-popover shadow-md">
                    {/* Search */}
                    <div className="flex items-center border-b px-3 py-2">
                        <svg className="mr-2 h-4 w-4 shrink-0 opacity-50" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
